 ...
 if (isset($_POST['submit'])) {
   ...
   if ($name !='') {
      ...
      if (is_numeric($name)) {
       ...
       $error1 ="<span style='color:red;'><br>Name can not be blank</span>"; 
   }
   ...
   if ($bsalary != '') {
      ...
      $error2 = "<span style='color:red;'><br>Basic salary can not be blank</span>";
   }
 }
...
<body>
   <form method="post">
      <table border="1" style="border-collapse: collapse;text-align: center;">
         <tr>
            <td colspan="2"><h1>Salary Slip</h1></td>
         </tr>
         <tr>
         ...
         <tr>
            <td colspan="2"><input type="submit" name="submit" style="background-color: blue; color: white; width:100px;height: 40px;padding: 10px;"></td>
         </tr>       
      </table>
   ...
   <table border="1px solid black" style="border-collapse:collapse;">
         ...
         <tr>
            ...
            <span style="padding-left: 80%;"><?php 
               if (isset($hra)) {
                  echo $hra;
               } ?></span>
            </td>
         ...
         <tr>
            ...
            <span style="padding-left: 90%;"><?php 
               if (isset($tg)) {
                  echo $tg;
               } ?></span></td>
         </tr>
         <tr>
            <td colspan="6">Net Takehome Salary 
            <span style="padding-left: 90%;"><?php 
