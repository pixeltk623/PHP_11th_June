...
<center>
<div class="alert alert-success" role="alert" style="width:70%; height:45px; font-size:22px">
				   ...
				   <div class="container">
					  <ul id="flexiselDemo3">
						<li>
							<div class="offer">
								<div class="offer-image">	
									<img src="<?php echo base_url();?>/assets/user/images/p1.jpg" class="img-responsive" alt=""/>
								</div>
						...
						<li>
							<div class="offer">
								<div class="offer-image">	
									<img src="<?php echo base_url();?>/assets/user/images/p2.jpg" class="img-responsive" alt=""/>
								</div>
								<div class="offer-text">
					...
					<div class="top-restaurent-grids">
						<div class="top-restaurent-logos">
							<div class="res-img-1 wow bounceIn" data-wow-delay="0.4s">
								<img src="<?php echo base_url();?>/assets/user/images/restaurent-1.jpg" class="img-responsive" alt="" />
							</div>
							<div class="res-img-2 wow bounceIn" data-wow-delay="0.4s">
							    <img src="<?php echo base_url();?>/assets/user/images/restaurent-2.jpg" class="img-responsive" alt="" />
							</div>
							<div class="res-img-1 wow bounceIn" data-wow-delay="0.4s">
							    <img src="<?php echo base_url();?>/assets/user/images/restaurent-3.jpg" class="img-responsive" alt="" />
							</div>
							<div class="res-img-2 wow bounceIn" data-wow-delay="0.4s">
							    <img src="<?php echo base_url();?>/assets/user/images/restaurent-4.jpg" class="img-responsive" alt="" />
							</div>
							<div class="res-img-1 nth-grid1 wow bounceIn" data-wow-delay="0.4s">
							    <img src="<?php echo base_url();?>/assets/user/images/restaurent-5.jpg" class="img-responsive" alt="" />
							</div>
							<div class="res-img-2 nth-grid1 wow bounceIn" data-wow-delay="0.4s">
							    <img src="<?php echo base_url();?>/assets/user/images/restaurent-6.jpg" class="img-responsive" alt="" />
							</div>
							<div class="clearfix"></div>
						</div>
					</div>
				...
				<div class="col-md-8 top-cuisines">
					...
					<div class="top-cuisine-grids">
						<div class="top-cuisine-grid wow bounceIn" data-wow-delay="0.4s">
						    <a href=""><img src="<?php echo base_url();?>/assets/user/images/cuisine1.jpg" class="img-responsive" alt="" /> </a>
							<label>Cuisine Name</label>
					    </div>
						<div class="top-cuisine-grid wow bounceIn" data-wow-delay="0.4s">
						    <a href=""><img src="<?php echo base_url();?>/assets/user/images/cuisine2.jpg" class="img-responsive" alt="" /> </a>
							<label>Cuisine Name</label>
					    </div>
						<div class="top-cuisine-grid wow bounceIn" data-wow-delay="0.4s">
						    <a href=""><img src="<?php echo base_url();?>/assets/user/images/cuisine3.jpg" class="img-responsive" alt="" /> </a>
							<label>Cuisine Name</label>
					    </div>
						<div class="top-cuisine-grid nth-grid wow bounceIn" data-wow-delay="0.4s">
						    <a href=""><img src="<?php echo base_url();?>/assets/user/images/cuisine4.jpg" class="img-responsive" alt="" /> </a>
							<label>Cuisine Name</label>
					    </div>
						<div class="top-cuisine-grid nth-grid1 wow bounceIn" data-wow-delay="0.4s">
						    <a href=""><img src="<?php echo base_url();?>/assets/user/images/cuisine5.jpg" class="img-responsive" alt="" /> </a>
							<label>Cuisine Name</label>
					    </div>
						<div class="top-cuisine-grid nth-grid1 wow bounceIn" data-wow-delay="0.4s">
						    <a href=""><img src="<?php echo base_url();?>/assets/user/images/cuisine6.jpg" class="img-responsive" alt="" /> </a>
							<label>Cuisine Name</label>
					    </div>
						<div class="top-cuisine-grid nth-grid1 wow bounceIn" data-wow-delay="0.4s">
						    <a href=""><img src="<?php echo base_url();?>/assets/user/images/cuisine7.jpg" class="img-responsive" alt="" /> </a>
							<label>Cuisine Name</label>
					    </div>
						<div class="top-cuisine-grid nth-grid nth-grid1 wow bounceIn" data-wow-delay="0.4s">
						    <a href=""><img src="<?php echo base_url();?>/assets/user/images/cuisine8.jpg" class="img-responsive" alt="" /> </a>
							<label>Cuisine Name</label>
					    </div>
						<div class="clearfix"></div>
					</div>
			...
			<div class="service-section-top-row">
				<div class="container">
					...
					<div class="col-md-5 service-section-top-row-grid3">
						<img src="<?php echo base_url();?>/assets/user/images/lunch.png" class="img-responsive" alt="" />
					</div>
			...
			<div class="service-section-bottom-row">
				<div class="container">
					<div class="col-md-4 service-section-bottom-grid wow bounceIn "data-wow-delay="0.2s">
						<div class="icon">
							<img src="<?php echo base_url();?>/assets/user/images/icon1.jpg" class="img-responsive" alt="" />
						</div>
						<div class="icon-data">
					...
					<div class="col-md-4 service-section-bottom-grid wow bounceIn "data-wow-delay="0.2s">
						<div class="icon">
							<img src="<?php echo base_url();?>/assets/user/images/icon2.jpg" class="img-responsive" alt="" />
						</div>
						<div class="icon-data">
					...
					<div class="col-md-4 service-section-bottom-grid wow bounceIn "data-wow-delay="0.2s">
						<div class="icon">
							<img src="<?php echo base_url();?>/assets/user/images/icon3.jpg" class="img-responsive" alt="" />
						</div>
						<div class="icon-data">
