...
<html>
<head>
<title>Admin:Add Main Package Category</title>
...
<body class="cbp-spmenu-push">
    ...
    <?php } ?>
					...
					<h2 class="title1">Add Main Package Category</h2>
					<div class="form-grids row widget-shadow" data-example-id="basic-forms"> 
						<div class="form-title">
							...
							<h4>Add Main Package Category :</h4>
						</div>
						<div class="form-body">
    ...
    <form method="post" action="<?php echo base_url();?>admin/AddMainPackageCategory">
           
        
                             
          <div class="form-group">             
           <label for="exampleInputPassword1">Enter Pacakge Name :-</label> <br><br>        
     <input name="mpcname" class="form-control" id="exampleInputPassword1" placeholder="Main Package Name">
     <span style="color: red"><?php echo form_error("mpcname");?></span>
							
      </div> 
      
     
     <br>
 <input type="submit"  name="addcat" class="btn btn-success" value="Add Main Category">
	...
	<div class="col-md-6">
	<img src="<?php base_url() ?>../assets/admin/images/tour1.jpg" alt="" class="img-responsive" />
	</div>
							</div>
