...
<html>
<head>
<title>Blogs:Add Flat Category</title>
...
<body class="cbp-spmenu-push">
    ...
    <?php } ?>
					...
					<h2 class="title1">Add Flat Category</h2>
    ...
    <form method="post" action="<?php echo base_url();?>admin/AddCategory">
      ...
      <div class="form-group"> 
          ...
          <div class="form-group"> 
          <label for="exampleInputEmail1">Select Flat Type :-</label> 
				 ...
				 <select name="catname" id="" class="form-control">
					 ...
					 <option value="1 BHK">4 BHK</option>
					</select>
