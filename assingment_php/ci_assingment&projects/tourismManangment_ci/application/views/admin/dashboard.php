...
<body class="cbp-spmenu-push">
    ...
    <?php } ?>
		...
		</div><h1 style="position: absolute;top:62%;left:45%;color:orange"><?php  echo $this->session->userdata("name") ?></h1>
		
				 <img src="<?php base_url() ?>../assets/admin/images/welcome.jpg" alt="" height="380px" width="100%"/><br>
