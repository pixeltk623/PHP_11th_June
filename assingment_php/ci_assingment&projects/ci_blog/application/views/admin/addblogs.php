...
<body class="cbp-spmenu-push">
    ...
    <?php } ?>
     ...
     <?php echo form_open_multipart('admin/addblog/do_upload');?> 
      ...
      <label for="exampleInputFile">Upload Blogs images</label>
      
    <input type="file" name="img" id="exampleInputFile">
     <p class="help-block">Upload blogs images.</p>      </div> 
     ...
     <textarea name="desc" class="form-control" id="exampleInputPassword1" placeholder="Descriptions"></textarea>
     
      </div> 
      
     
     
 <input type="submit"  name="sub" class="btn btn-success" value="Add Blogs">
