...
//--//--//--//--------------
	...
	//  		echo "Present";
    //        echo $photoExistError= "Please Upload Photo With Another File Name";
	//  	} else {
	//  		$photo;
	//  	}
    //  `profile_pic`='$newPhotoName',
    //--//--//--//--------------

            $query = "UPDATE `users` SET `full_name`='$fullName',`username`='$uname',`hobby`='$hobby1',`email`='$Email',`profile_pic`='$new2',`mobile`='$mobile',`Password`='$Password' WHERE sr_no =".$_SESSION['user_id'];
