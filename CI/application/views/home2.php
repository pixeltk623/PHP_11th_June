...
<link rel="shortcut icon" href="<?php echo base_url('assets/assets_front/images/favicon.png') ?>" />
<!-- Plugins CSS -->
<link rel="stylesheet" href="<?php echo base_url('assets/assets_front/css/plugins.css') ?> ">
<!-- Bootstap CSS -->
<link rel="stylesheet" href="<?php echo base_url('assets/assets_front/css/bootstrap.min.css') ?>">
<!-- Main Style CSS -->
<link rel="stylesheet" href="<?php echo base_url('assets/assets_front/css/style.css') ?>">
<link rel="stylesheet" href="<?php echo base_url('assets/assets_front/css/responsive.css') ?>">
</head>
...
<div class="pageWrapper">
                	...
                	<div class="site-cart">
                        ...
                        <div id="header-cart" class="block block-cart">
                        	<ul class="mini-products-list">
                                ...
                                <li class="item">
                                	<a class="product-image" href="#">
                                    	<img src="<?php echo base_url('assets/assets_front/images/product-images/cape-dress-2.jpg') ?>" alt="Elastic Waist Dress - Black / Small" title="" />
                                    </a>
                                    <div class="product-details">
                                    	<a href="#" class="remove"><i class="anm anm-times-l" aria-hidden="true"></i></a>
                                        <a href="#" class="edit-i remove"><i class="anm anm-edit" aria-hidden="true"></i></a>
	...
	<!-- End Newsletter Popup -->
     ...
     <!-- Including Jquery -->
     <script src="<?php echo base_url('assets/assets_front/js/vendor/jquery-3.3.1.min.js') ?>"></script>
     <script src="<?php echo base_url('assets/assets_front/js/vendor/modernizr-3.6.0.min.js') ?>"></script>
     <script src="<?php echo base_url('assets/assets_front/js/vendor/jquery.cookie.js') ?>"></script>
     <script src="<?php echo base_url('assets/assets_front/js/vendor/wow.min.js') ?>"></script>
     <script src="<?php echo base_url('assets/assets_front/js/vendor/instagram-feed.js') ?>"></script>
     <!-- Including Javascript -->
     <script src="<?php echo base_url('assets/assets_front/js/bootstrap.min.js') ?>"></script>
     <script src="<?php echo base_url('assets/assets_front/js/plugins.js') ?>"></script>
     <script src="<?php echo base_url('assets/assets_front/js/popper.min.js') ?>"></script>
     <script src="<?php echo base_url('assets/assets_front/js/lazysizes.js') ?>"></script>
     <script src="<?php echo base_url('assets/assets_front/js/main.js') ?>"></script>
     <!--Instagram Js-->
     <script>
