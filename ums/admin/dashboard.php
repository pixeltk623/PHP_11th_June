        ...
        <ul class="nav pull-right top-menu">
          ...
          <li id="mail_notificatoin_bar" class="dropdown">
            ...
            <ul class="dropdown-menu extended inbox">
              ...
              <li>
                <a href="#">
                                    <span class="photo"><assets/img alt="avatar" src="./assets/img/avatar-mini.jpg"></span>
                                    <span class="subject">
              ...
              <li>
                <a href="#">
                                    <span class="photo"><assets/img alt="avatar" src="./assets/img/avatar-mini2.jpg"></span>
                                    <span class="subject">
              ...
              <li>
                <a href="#">
                                    <span class="photo"><assets/img alt="avatar" src="./assets/img/avatar-mini3.jpg"></span>
                                    <span class="subject">
              ...
              <li>
                <a href="#">
                                    <span class="photo"><assets/img alt="avatar" src="./assets/img/avatar-mini4.jpg"></span>
                                    <span class="subject">
            ...
            <div class="panel panel-default">
              ...
              <div class="panel-body">
                <table class="table bootstrap-datatable countries">
                  ...
                  <tbody>
                    <tr>
                      <td><assets/img src="assets/img/Germany.png" style="height:18px; margin-top:-2px;"></td>
                      <td>Germany</td>
                      <td>2563</td>
                      <td>1025</td>
                      <td>
                    ...
                    <tr>
                      <td><assets/img src="assets/img/India.png" style="height:18px; margin-top:-2px;"></td>
                      <td>India</td>
                      <td>3652</td>
                      <td>2563</td>
                      <td>
                    ...
                    <tr>
                      <td><assets/img src="assets/img/Spain.png" style="height:18px; margin-top:-2px;"></td>
                      <td>Spain</td>
                      <td>562</td>
                      <td>452</td>
                      <td>
                  ...
                  <ul class="chats">
                    ...
                    <li class="by-me">
                      ...
                      <div class="avatar pull-left">
                        <assets/img src="assets/img/user.jpg" alt="" />
                      </div>
                    ...
                    <li class="by-other">
                      ...
                      <div class="avatar pull-right">
                        <assets/img src="assets/img/user22.png" alt="" />
                      </div>
                ...
                <div class="row">
                  ...
                  <div class="col-lg-4">
                    <span class="profile-ava pull-right">
                                        <assets/img alt="" class="simple" src="assets/img/avatar1_small.jpg">
                                        Jenifer smith
                                </span>
                  </div>
                </div>
